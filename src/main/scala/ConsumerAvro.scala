...
object ConsumerAvro {
  def main(args: Array[String]) {
    ...
    val consumer = new KafkaConsumer[Int, User](props)

    consumer.subscribe(Collections.singletonList("user-avro2"), new ConsumerRebalanceListener {
